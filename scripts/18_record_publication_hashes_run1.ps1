# Record SHA-256 hashes for the publication reproducibility audit.
# Run from the repository root:
# powershell -ExecutionPolicy Bypass -File scripts\18_record_publication_hashes_run1.ps1
...
$outfile = "outputs\tables\publication_hashes_run1.txt"
...
Write-Host ""
Write-Host "Run 1 hashes written to:"
Write-Host "  $outfile"
Write-Host ""
